...
import ClaudeChatWindow from "../claude-web/ClaudeChatWindow";
      ...
      <div className="container mx-auto max-w-6xl px-4 sm:px-6">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-5xl font-bold text-foreground mb-4">
            This Claude Desktop MCP will enable you to
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Two superpowers Claude Desktop does not have on its own: your files and your terminal.
          </p>
        </div>
        ...
        <div className="text-center">
          <CdCta position="capabilities" label="Try it in Claude Desktop" />
        </div>
      </div>
    </section>
  );
