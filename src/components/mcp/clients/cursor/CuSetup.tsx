        ...
        <div className="grid sm:grid-cols-2 gap-5 mb-10 text-left">
          <Card className="p-7 bg-dc-card border-dc-border relative overflow-hidden">
            ...
            <p className="text-muted-foreground leading-relaxed relative">
              Open Remote Desktop Commander on cursor.directory and follow Add to
              Cursor. The plugin registers in your MCP settings.
            </p>
          </Card>
          <Card className="p-7 bg-dc-card border-dc-border relative overflow-hidden">
            <span
            ...
            <p className="text-muted-foreground leading-relaxed relative">
              Follow the instructions shown when you connect. You will run one command in
              your computer's terminal and your machine appears in Cursor.
            </p>
          </Card>
        </div>

        <CuCta position="setup" className="text-base px-8" />
