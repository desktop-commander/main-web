...
const HIGHLIGHTS = [
  {
    ...
    description:
      "Desktop Commander is a local MCP server. It starts with Cursor, works directly on your files and terminal, and needs no cloud account.",
  },
  {
    icon: Lock,
    title: "Keep everything local",
    description:
      "Pair it with local models in Cursor and nothing has to leave your computer. Your code, your files, your machine.",
  },
  {
    icon: GitBranch,
    title: "Free and open source",
    description:
      "The same MCP server trusted across Claude Desktop, Windsurf, and VS Code setups, with 26k+ weekly downloads.",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              No remote bridge, no account, no middleman. Cursor talks to Desktop
              Commander over local MCP and Desktop Commander works directly on your disk
              and terminal.
            </p>
          ...
          >
            <div className="relative rounded-2xl border-2 border-dashed border-primary/30 bg-dc-surface/40 p-6 md:p-8">
              ...
              <div className="space-y-4">
                {/* Cursor node */}
                <div className={`flex items-center gap-3 rounded-xl bg-dc-card border border-dc-border px-4 py-3.5 ${nodeStep(0)}`} style={{ transitionDelay: "200ms" }}>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">cloud or local models</p>
                  </div>
                </div>
                ...
                {/* DC node */}
                <div className={`flex items-center gap-3 rounded-xl bg-dc-card border border-primary/40 px-4 py-3.5 ${nodeStep(1)}`} style={{ transitionDelay: "500ms" }}>
                  <span className="w-9 h-9 rounded-lg bg-white flex items-center justify-center">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    return (
                      <div
                        key={node.label}
                        className={`flex flex-col items-center gap-2 rounded-xl bg-dc-card border border-dc-border px-2 py-3.5 text-center ${nodeStep(2 + i)}`}
