          ...
          <div className="relative">
            <div className="flex items-center justify-center gap-4 mb-7">
              ...
              <span className="w-12 h-12 rounded-xl border border-dc-border bg-white flex items-center justify-center">
                <img src="/claude-logo.png" alt="Claude" className="w-7 h-7 object-contain" />
              </span>
            </div>
            <h2 className="text-3xl sm:text-5xl font-bold text-foreground mb-4">
              Your computer is Claude's
              <br className="hidden sm:block" /> missing superpower
            </h2>
            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-9">
              Add the Desktop Commander connector and start working with real files and a
              real terminal today.
            </p>
            <CwCta position="final" className="text-base px-10" />
          </div>
        </div>
      </div>
    </section>
