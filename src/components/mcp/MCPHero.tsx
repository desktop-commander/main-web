...
import { ArrowRight, Github, Star, Download, FolderOpen, Terminal, Cpu } from "lucide-react";
...
const CLIENTS = [
  { slug: "chatgpt", name: "ChatGPT", x: 60 },
  { slug: "claude-web", name: "Claude Web", logo: "/claude-logo.png", x: 155 },
  { slug: "claude-desktop", name: "Claude Desktop", logo: "/claude-logo.png", x: 250 },
  { slug: "cursor", name: "Cursor", logo: "/cursor-mark.png", x: 345 },
];
          ...
          <div className={`lg:col-span-6 ${reveal("delay-400")}`}>
            <div className="relative max-w-md mx-auto select-none">
              ...
              <div className="relative flex flex-col items-center">
                ...
                <span className="relative text-xs text-muted-foreground">one MCP server, every client</span>
              </div>
