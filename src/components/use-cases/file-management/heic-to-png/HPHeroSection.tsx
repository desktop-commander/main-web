      ...
      <div className="container mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight max-w-4xl">
            Convert HEIC to PNG <span className="text-primary">with transparency</span>
          </h1>

          {/* Subheadline */}
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl leading-relaxed">
            Need PNG files with transparent backgrounds? Convert your iPhone HEIC photos to PNG locally and instantly. Perfect for graphics, logos, and images that need transparency support.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button 
              ...
              className="group"
            >
              <a href="#get-started" onClick={() => trackDownloadRedirect('heic_to_png_hero')}>
