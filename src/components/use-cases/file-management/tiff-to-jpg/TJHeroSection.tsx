      ...
      <div className="container mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight max-w-4xl">
            Convert TIFF to JPG <span className="text-primary">effortlessly</span>
          </h1>

          {/* Subheadline */}
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl leading-relaxed">
            Batch convert TIFF files from scanners, print workflows, and professional cameras to universally compatible JPG. No uploads, no complex software.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button 
              ...
              className="group"
            >
              <a href="#get-started" onClick={() => trackDownloadRedirect('tiff_to_jpg_hero')}>
