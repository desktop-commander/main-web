      ...
      <div className="container mx-auto max-w-4xl px-4 sm:px-6">
        <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent rounded-2xl border border-primary/20 p-8 md:p-12 text-center">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Finally, AVIF conversion that just works.
          </h2>

          {/* Description */}
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            No hunting for apps that support AVIF. No uploads. No limits. Just instant local conversion.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <DownloadButtons variant="hero" location="avif_to_jpg" />
          </div>
...
export default AJFinalCTASection;
