...
export const mcpClients: McpClient[] = [
  ...
  },
  {
    ...
    howItConnects: {
      ...
      bullets: [
        'Free & open source — 150k+ weekly downloads',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. The local MCP server is free and open source (150k+ weekly downloads). You only need a Claude account for Claude Desktop itself.',
      },
      {
