import{b as y,r as f}from"./index.CWXBSLiN.js";var _={exports:{}},c={};/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const O=f.forwardRef(({color:o="currentColor",size:r=24,strokeWidth:n=2,absoluteStrokeWidth:s,className:a="",children:u,iconNode:m,...i},e)=>f.createElement("svg",{ref:e,...k,width:r,height:r,stroke:o,strokeWidth:s?Number(n)*24/Number(r):n,className:w("lucide",a),...i},[...m.map(([p,t])=>f.createElement(p,t)),...Array.isArray(u)?u:[u]]));/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const C=(o,r)=>{const n=f.forwardRef(({className:s,...a},u)=>f.createElement(O,{ref:u,iconNode:r,className:w(`lucide-${b(o)}`,s),...a}));return n.displayName=`${o}`,n};export{C as c,j};
