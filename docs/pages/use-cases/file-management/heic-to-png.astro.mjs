...
import { Download, ArrowRight, AlertCircle, Zap, FolderOpen, Sparkles, CheckCircle, XCircle, Palette, Briefcase, Users } from 'lucide-react';
...
const HPHeroSection = () => {
  return /* @__PURE__ */ jsx("section", { className: "pt-32 pb-16 md:pt-40 md:pb-20", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-6xl px-4 sm:px-6", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center space-y-8", children: [
    /* @__PURE__ */ jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight max-w-4xl", children: [
      "Convert HEIC to PNG ",
      /* @__PURE__ */ jsx("span", { className: "text-primary", children: "with transparency" })
    ] }),
    /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl text-muted-foreground max-w-3xl leading-relaxed", children: "Need PNG files with transparent backgrounds? Convert your iPhone HEIC photos to PNG locally and instantly. Perfect for graphics, logos, and images that need transparency support." }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-3 pt-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "px-3 py-1.5 rounded-full bg-dc-surface border border-dc-border text-sm font-medium", children: "HEIC → PNG" }),
        /* @__PURE__ */ jsx("span", { className: "px-3 py-1.5 rounded-full bg-dc-surface border border-dc-border text-sm font-medium", children: "HEIF → PNG" }),
        ...
        /* @__PURE__ */ jsx("span", { className: "px-3 py-1.5 rounded-full bg-dc-surface border border-dc-border text-sm font-medium", children: "Transparency Support" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-col sm:flex-row gap-4 pt-4", children: /* @__PURE__ */ jsx(
      Button,
      {
        ...
        asChild: true,
        className: "group",
        children: /* @__PURE__ */ jsxs("a", { href: "#get-started", onClick: () => trackDownloadRedirect("heic_to_png_hero"), children: [
...
const HPProblemSection = () => {
  return /* @__PURE__ */ jsx("section", { className: "py-16 md:py-20", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-5xl px-4 sm:px-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-dc-card to-dc-surface rounded-2xl border border-dc-border p-8 md:p-12", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl font-bold", children: "PNG is the standard. HEIC isn't." })
    ] }),
    /* @__PURE__ */ jsx("p", { className: "text-xl text-muted-foreground leading-relaxed", children: "Designers, developers, and content creators need PNG for its lossless quality and transparency support. But your iPhone saves everything as HEIC. Online converters compress your images, strip metadata, or require you to upload sensitive photos to unknown servers." })
  ] }) }) });
};
...
const HPSolutionSection = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-gradient-to-b from-background to-dc-card/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-6xl px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-bold mb-6", children: "Just describe what you need. Done." }),
      /* @__PURE__ */ jsx("p", { className: "text-xl text-muted-foreground max-w-3xl mx-auto", children: "No settings to configure. No apps to learn. Just tell Desktop Commander what you want in plain English." })
    ] }),
...
const HPComparisonSection = () => {
  ...
  const withoutDC = [
    ...
    "Quality often compressed or degraded",
    "Convert one file at a time",
    "Requires internet connection",
    "Ads, watermarks, or paid upgrades"
  ];
  return /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-gradient-to-b from-background to-dc-card/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-6xl px-4 sm:px-6", children: [
  ...
  const personas = [
    {
      ...
      color: "blue",
      useCases: [
        "Convert iPhone photos for use in Figma or Sketch",
        "Prepare images with transparency for web graphics",
        "Batch process product photography"
      ]
    },
    {
      icon: Briefcase,
      title: "Developers & Marketers",
      color: "purple",
      useCases: [
        "Convert app screenshots for documentation",
        "Prepare images for websites and landing pages",
        "Process marketing assets in bulk"
      ]
    },
    {
      icon: Users,
      ...
      color: "green",
      useCases: [
        "Convert thumbnails and social media graphics",
        "Prepare images for video editing software",
        "Organize and convert content libraries"
      ]
    }
  ];
...
const HPFinalCTASection = () => {
  return /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-4xl px-4 sm:px-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-primary/10 via-primary/5 to-transparent rounded-2xl border border-primary/20 p-8 md:p-12 text-center", children: [
    /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-bold mb-6", children: "Get perfect PNGs from your iPhone photos." }),
    /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto", children: "Convert HEIC to PNG locally with lossless quality. No uploads, no quality loss, no limits." }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-col sm:flex-row gap-4 justify-center mb-8", children: /* @__PURE__ */ jsx(DownloadButtons, { variant: "hero", location: "heic_to_png" }) }),
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Convert HEIC to PNG Instantly | Free Local Converter | Desktop Commander", "description": "Convert iPhone HEIC photos to PNG with lossless quality. Batch convert locally with transparency support. No uploads required. Free for Mac and Windows." }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "PostHogInit", PostHogInit, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/rk/DC/main-web/src/components/PostHogInit", "client:component-export": "default" })} ${maybeRenderHead()}<div class="min-h-screen bg-background"> ${renderComponent($$result2, "NavigationLandingPage", NavigationLandingPage, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/rk/DC/main-web/src/components/NavigationLandingPage", "client:component-export": "default" })} <main> ${renderComponent($$result2, "HPHeroSection", HPHeroSection, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/rk/DC/main-web/src/components/use-cases/file-management/heic-to-png/HPHeroSection", "client:component-export": "default" })} ${renderComponent($$result2, "HPProblemSection", HPProblemSection, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/rk/DC/main-web/src/components/use-cases/file-management/heic-to-png/HPProblemSection", "client:component-export": "default" })} ${renderComponent($$result2, "HPSolutionSection", HPSolutionSection, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/rk/DC/main-web/src/components/use-cases/file-management/heic-to-png/HPSolutionSection", "client:component-export": "default" })} ${renderComponent($$result2, "HPComparisonSection", HPComparisonSection, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/rk/DC/main-web/src/components/use-cases/file-management/heic-to-png/HPComparisonSection", "client:component-export": "default" })} ${renderComponent($$result2, "WaitlistSection", WaitlistSection, { "useCase": "heic_to_png", "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/rk/DC/main-web/src/components/use-cases/WaitlistSection", "client:component-export": "default" })} ${renderComponent($$result2, "HPPersonasSection", HPPersonasSection, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/rk/DC/main-web/src/components/use-cases/file-management/heic-to-png/HPPersonasSection", "client:component-export": "default" })} ${renderComponent($$result2, "HPFinalCTASection", HPFinalCTASection, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/rk/DC/main-web/src/components/use-cases/file-management/heic-to-png/HPFinalCTASection", "client:component-export": "default" })} </main> ${renderComponent($$result2, "Footer", Footer, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/rk/DC/main-web/src/components/Footer", "client:component-export": "default" })} </div> ` })} `;
}, "/Users/rk/DC/main-web/astro-src/pages/use-cases/file-management/heic-to-png/index.astro", void 0);

const $$file = "/Users/rk/DC/main-web/astro-src/pages/use-cases/file-management/heic-to-png/index.astro";
const $$url = "/use-cases/file-management/heic-to-png/";
